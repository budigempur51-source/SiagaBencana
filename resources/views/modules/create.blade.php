            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('modules.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <x-input-label for="cover_image" :value="__('Sampul Modul (Gambar)')" />
                        ...
                        <div class="mb-4">
                            <x-input-label for="file" :value="__('File Dokumen (PDF)')" />
                            <input id="file" type="file" name="file" accept=".pdf" class="block mt-1 w-full border border-gray-300 rounded p-1" required />
                        ...
                        <div class="block mt-4 mb-4">
                            <label for="is_featured" class="inline-flex items-center">
                                <input id="is_featured" type="checkbox" name="is_featured" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
